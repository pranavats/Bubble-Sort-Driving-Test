...
baseurl:
	python3 ./Scripts/replaceBaseURL.py ./Scripts/backendLink.txt ./Frontend/src/pages/api.js
...
poc:
	python3 ./Scripts/replacePOC.py ./Scripts/POC.txt ./Frontend/src/pages/Homepage.js
...
summary:
	python3 -m pip install --upgrade -r ./Data-Processing/pythonRequirements.txt --no-cache-dir
	python3 ./Data-Processing/cleandata.py ./Data-Processing/runTable.csv ./Data-Processing/runTransitionTable.csv ./Data-Processing/experiment.json
	python3 ./Data-Processing/prelim_scores.py ./Data-Processing/experiment.json ./Data-Processing/metrics.json
	python3 ./Data-Processing/dumpdata.py ./Data-Processing/metrics.json ./Data-Processing/summary.csv
